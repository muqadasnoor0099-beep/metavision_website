        ...
        {steps.map((step, i) => (
          ...
          >
            <GlassCard>
              ...
              <h3 className="text-white font-heading font-semibold mb-1">{step.title}</h3>
              {step.subtitle && (
                <div className="text-gold text-[11px] font-semibold uppercase tracking-wider mb-2">{step.subtitle}</div>
              )}
