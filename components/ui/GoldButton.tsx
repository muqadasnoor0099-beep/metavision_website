...
export default function GoldButton({ children, href, onClick, size = 'md', className = '', type = 'button', disabled }: Props) {
  const base = `inline-flex items-center justify-center font-bold bg-gradient-to-r from-gold to-gold-light text-white rounded-[10px] transition-all duration-200 hover:opacity-90 hover:scale-[1.02] active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold/50 disabled:opacity-50 disabled:cursor-not-allowed disabled:scale-100 ${
